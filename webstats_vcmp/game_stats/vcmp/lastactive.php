...
<center><h1>Last Active</h1>
<form class="form-inline" action="search_player_db/lastactive.php" method="post">
...
$cars = "SELECT Name, LADate FROM lastactive";
$result = $conn->query($cars);
//echo "<br><br><hr><hr><hr><h1>Last Active</h1><hr><hr><hr>";
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {?>
		<tr>
		<td><?php echo "<font color='red'>". $row["Name"]. "</font>";?></td>
		<td><?php echo "<font color='blue'>". $row["LADate"]. "</font>";?></td>
