...
<center><h1>Weapon - Stats</h1>
<form class="form-inline" action="search_player_db/wstats.php" method="post">
...
$wstats = "SELECT Name, User, Fist, BrassKnuckle, ScrewDriver, GolfClub, NightStick, Knife, BaseballBat, Hammer, Cleaver, Machete, Katana, Chainsaw, Grenade, RemoteGrenade, TearGas, Molotov, Missile, Colt45, Python, Shotgun, Spaz, Stubby, Tec9, Uzi, Ingrams, MP5, M4, Ruger,  SniperRifle, LaserScope, RocketLauncher, FlameThrower, M60 FROM wstats";
$result = $conn->query($wstats);
//echo "<br><br><hr><hr><hr><h1>Weapon - Stats</h1><hr><hr><hr>";
